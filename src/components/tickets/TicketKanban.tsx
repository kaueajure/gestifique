...
import { MessageSquare, User as UserIcon, Calendar, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="flex gap-4 overflow-x-auto pb-4 pt-2 -mx-2 px-2 snap-x">
      {kanbanData.columns.map(column => (
        <div key={column.id} className="flex-1 min-w-[280px] max-w-[350px] bg-slate-50/50 rounded-xl p-3 border border-slate-200/60 snap-center flex flex-col">
           ...
           <div className="flex flex-col gap-3 flex-1">
             {column.tickets.map(ticket => (
               <div 
                 ...
                 className={cn(
                   "bg-white rounded-lg p-3 shadow-sm border border-slate-200 cursor-pointer hover:shadow-md transition-all group relative",
               ...
               >
                 ...
                 {/* Ações Rápidas - Ocultas até hover, a menos que seja mobile */}
                 {canManage && (
