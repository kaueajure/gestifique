      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        {error ? (
          <div className="p-20 text-center flex flex-col items-center">
             ...
             <h4 className="font-bold text-slate-800">Falha ao buscar logs de auditoria</h4>
             <p className="text-sm text-slate-500 mb-6">{error}</p>
             <button onClick={() => fetchLogs()} className="text-xs font-black text-blue-600 uppercase tracking-widest hover:underline">Tentar novamente</button>
          </div>
        ) : (
