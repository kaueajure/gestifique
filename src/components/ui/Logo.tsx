...
export const FallbackLogo = ({ size = 24, className }: LogoProps) => (
  <div 
    className={cn("flex flex-shrink-0 items-center justify-center bg-[#0052FF] text-white rounded-lg", className)}
    style={{ width: size, height: size }}
  >
    <svg width={size * 0.6} height={size * 0.6} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
